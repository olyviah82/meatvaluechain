...
const columns = [
  ...
  { id: 'mname', label: 'RanchName', minWidth: 170 },
                  ...
                  <Grid item xs={6}>
                    <Paper className={classes.ProductPaper}>
                      <div>
                        ...
                        <div className={classes.ExplorerdRow}>
                          Farmer : {productData[0][3]}
                        </div>
                        <div className={classes.ExplorerdRow}>
                          Name of Farmer : {productData[0][4]}
                        </div>
                        <div className={classes.ExplorerdRow}>
                          Details of Farmer : {productData[0][5]}
                        </div>
                        <div className={classes.ExplorerdRow}>
                          Longitude of the Farm : {productData[0][6]}
                        </div>
                        <div className={classes.ExplorerdRow}>
                          Latitude of the Farm : {productData[0][7]}
                        </div>
                        <div className={classes.ExplorerdRow}>
